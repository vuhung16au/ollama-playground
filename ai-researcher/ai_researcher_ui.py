...
from ai_researcher_ui_control import render_control_panel as render_control_panel_component
from ai_researcher_ui_metrics import render_metrics_dashboard as render_metrics_dashboard_component
from ai_researcher_ui_progress import render_progress_tracking as render_progress_tracking_component
from ai_researcher_ui_results import render_research_results as render_research_results_component
from ai_researcher_ui_welcome import render_welcome_message as render_welcome_message_component
...
def display_enhanced_metrics(response_state, research_start_time, search_quality):
    ...
    from ai_researcher_ui_analytics import display_enhanced_metrics as display_enhanced_metrics_component
...
def display_content_analysis(content_insights):
    ...
    from ai_researcher_ui_analytics import display_content_analysis as display_content_analysis_component
...
def display_research_history():
    ...
    from ai_researcher_ui_analytics import display_research_history as display_research_history_component
