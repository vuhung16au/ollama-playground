...
from research_gpt_config import STEP_NAMES, log_file
...
def render_research_results(response_state, query, model_used, total_research_time, enable_detailed_analysis, show_debug_info):
    ...
    # Enhanced Metrics Dashboard
    try:
        from research_gpt_ui_analytics import display_enhanced_metrics
    ...
    if enable_detailed_analysis:
        try:
            from research_gpt_ui_analytics import display_content_analysis
